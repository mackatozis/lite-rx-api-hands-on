...
/**
 * Learn how to call blocking code from Reactive one with adapted concurrency strategy for blocking code that produces or receives
 * data.
 * <p>
 * For those who know RxJava: - RxJava subscribeOn = Reactor subscribeOn - RxJava observeOn = Reactor publishOn - RxJava Schedulers.io
 * <==> Reactor Schedulers.elastic
 *
